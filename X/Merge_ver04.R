...
## in this version we added 2021 data 
## and we do not use rasters and voxels
## we rename outputs with suffix v2
...
write.csv(df.merged , "main.df.merged.2021_v2.csv", row.names=FALSE)
remove(df.merged)
