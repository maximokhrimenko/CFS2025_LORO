...
#rm(CFS.DF.modeling, CFS.DF.modeling.first, df_validation)

CFS.DF.modeling <- read.csv("~/myR_projects/CFS2022_models/LOOV/CFS.DF.Unique.v4_Jan2025v1.csv")
...
df_validation.out <- rbind(df_validation.out, df_validation)
  ...
  write.csv(df_validation.out, paste0("2025.LOOV.", AGB.input[k],".Linear.csv"))
