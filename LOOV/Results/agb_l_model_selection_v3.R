...
threshold_file <- "selected_models_agb_l_baselines_and_thresholds_2percent.txt"
capture.output({
  ...
  cat("Threshold %rmse.regional.max (min + 2%):", regional_rmse_threshold, "\n")
...
filtered_models_file <- "selected_models_agb_l_2p.csv"
