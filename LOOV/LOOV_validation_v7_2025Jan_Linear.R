...
CFS.DF.modeling <- read.csv("CFS.DF.Unique.v4_Jan2025v3.csv") ### resolved issues with metrics, shoudl be v3
...
regfit.model.first = regsubsets(AGB ~ . , data = CFS.DF.modeling.first, nbest = 500, nvmax = 3, really.big = T, intercept = T)
...
df_validation$AGB_input[i] = AGB.input[k]  ## "agb_l" or "agb_lad"
df_validation$Metrics_input[i] = Metrics.input[l] ## "C2", "C2FR", "ms" 
